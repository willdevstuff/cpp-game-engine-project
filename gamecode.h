...
private:
	...
	//PictureIndex background; <-- didnt seem to work

	// booleans to control gamestate
	bool gameOver;
	bool gameWon;
	// <-- Own stuff ends
...
public:
   ...
   // This is called just before the program exits
	...
	// Handles messages - declared here because codecodeis not a gameobject that inherits this function
